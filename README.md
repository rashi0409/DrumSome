...
Hit "Play Recording" to hear your creation.
3. Adjust Volume or Mute
Use the slider to control volume or click the speaker icon to mute/unmute.
4. Dark Mode
Toggle dark mode using the moon icon for a night-friendly view.
5. Background Music
...
├── index.js           # JavaScript logic for sound, recording, themes
├── styles.css         # Styling for the UI and themes
├── sounds/            # Folder containing .mp3 drum sound files
